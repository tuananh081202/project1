...
const UserDashboard = () => {
    ...
    useEffect(() => {
        ...
        Promise.all([ promiseCategory, promiseProduct, promiseRating]).then(res => {
            console.log('res=>', res)
            setDashboardData({
                ...DashboardData, totalCategory: res[0].data.total, totalProduct: res[1].data.total, totalRating: res[2].data.total
            })
